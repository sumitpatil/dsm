                ...
                <table class="table table-bordered table-striped" id="user_table">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th colspan="2">{{$power_plant_location_name}} 
                                <input type="hidden" name="power_plant_name" value="{{$power_plant_location_name}}" /> 
                            </th>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        ...
                        @foreach ($unit_wise_stage_wise_details as $unit_wis_stage_wise_detail)
                            <tr>
                                <th>{{$i}} </th>
                                <th>
                                    unit-{{$unit_wis_stage_wise_detail->unit}} 
                                    <input type="hidden" name="unit_name[]" class="form-control" 
                                       value="{{$unit_wis_stage_wise_detail->unit}}" />
                                </th>
                                <th>
                                    stage-{{$unit_wis_stage_wise_detail->stage}} 
                                    <input type="hidden" name="stage_name[]" class="form-control" 
                                       value="{{$unit_wis_stage_wise_detail->stage}}" />
                                </th>
                                <th>
                                    {{$unit_wis_stage_wise_detail->capacity}} MW 
                                    <input type="hidden" name="capacity_name[]" class="form-control" 
                                       value="{{$unit_wis_stage_wise_detail->capacity}}" />
                                </th>
                            </tr>
